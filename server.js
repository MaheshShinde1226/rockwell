...
var onAboutUs=function(req, res){
    res.send("Chief Mentor :Tushar Sthul");
};
var onDefault=function(req, res){
    res.send("<h1>Rockwell Automation Inc.</h1>"+
              "<hr/>"+
              "<ol>"+
                    " <li>Manager:Mahesh Shinde</li>"+
                    " <li>MD: Naman Saxena</li>"+
                    " <li>CEO: Amey Joshi</li>"+
                    " <li>CTO: Prajakta Mutyalwar</li>"+
             "</ol>");
};
